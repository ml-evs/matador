...
class ImportTest(unittest.TestCase):
    ...
    def test_db(self):
        from matador.db import (
            make_connection_to_collection, Spatula, DatabaseChanges, Refiner
        )
    ...
    def test_export(self):
        from matador.export import (
            doc2param, doc2cell, doc2pdb, doc2pwscf,
            doc2res, doc2xsf, generate_hash, query2files, doc2arbitrary
        )
    ...
    def test_fingerprints(self):
        from matador.fingerprints import (
            ...
            PXRD, Fingerprint, FingerprintFactory, get_uniq_cursor
        )
        self.assertTrue(all([
            PDF, PDFOverlap, CombinedProjectedPDF,
            PXRD, Fingerprint, FingerprintFactory, get_uniq_cursor
    ...
    def test_hull(self):
        from matador.hull import (
            QueryConvexHull, EnsembleHull,
            PhaseDiagram, HullDiff, diff_hulls
        )
