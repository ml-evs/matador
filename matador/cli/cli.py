...
def main(no_quickstart=False):
    ...
    structure_flags.add_argument('-kpttol', '--kpoint_tolerance', type=float,
                                 help='kpoint tolerance for calculation matches (DEFAULT: +/- 0.01 1/Å)')
    structure_flags.add_argument('-presstol', '--pressure_tolerance', type=float,
    ...
    query_flags.add_argument('--json', action='store_true',
