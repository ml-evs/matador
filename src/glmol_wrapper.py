def get_glmol_placeholder_string():
    """ Generate the GLMol example string to embed. """
    html_string = '''
                    <center>
    ...
    js_string = '''
                    ...
                    PLACEHOLDER
                    <div id="glmol02" style="width: 800px; height: 600px; background-color: white;"></div> <textarea id="glmol02_src" style="display: none;">
