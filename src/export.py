...
def query2files(cursor, res=False, cell=False, top=False, pressure=None, *args):
...
def doc2param(doc, path, *args):
    ...
    param_list = ['task', 'cut_off_energy', 'xc_functional',
                 'finite_basis_corr', 'spin_polarized', 
                 'write_bib', 'finite_basis_corr', 'calculcate_stress',
                 'page_wvfns', 'geom_opt_method', 'geom_max_iter']
    param_dict = dict()
