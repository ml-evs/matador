...
project = 'matador'
copyright = '2016-2018, Matthew Evans'
...
# documentation.
#
html_theme_options = {'canonical_url': 'https://matador-database.readthedocs.io/en/latest/',
...
latex_documents = [
    (master_doc, 'matador.tex', 'matador Documentation',
...
man_pages = [
    (master_doc, 'matador', 'matador Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'matador', 'matador Documentation',
     author, 'matador', 'One line description of project.',
     'Miscellaneous'),
]
